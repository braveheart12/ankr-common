...
func init() {
	proto.RegisterType((*PingMsg)(nil), "util.PingMsg")
}
...
var fileDescriptor_6d51d96c3ad891f5 = []byte{
	...
	0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x29, 0x2d, 0xc9, 0xcc, 0x51, 0x92, 0xe4, 0x62,
	0x0f, 0xc8, 0xcc, 0x4b, 0xf7, 0x2d, 0x4e, 0x17, 0xe2, 0xe3, 0x62, 0xca, 0x4c, 0x91, 0x60, 0x54,
	0x60, 0xd4, 0xe0, 0x0c, 0x62, 0xca, 0x4c, 0x31, 0xd2, 0xe3, 0x62, 0x01, 0x49, 0x09, 0xa9, 0x41,
	0x69, 0x5e, 0x3d, 0x90, 0x0e, 0x3d, 0xa8, 0x72, 0x29, 0x54, 0xae, 0x12, 0x43, 0x12, 0x1b, 0xd8,
	0x5c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6b, 0xff, 0x51, 0x10, 0x65, 0x00, 0x00, 0x00,
}
...
func (c *pingClient) Ping(ctx context.Context, in *PingMsg, opts ...grpc.CallOption) (*PingMsg, error) {
	out := new(PingMsg)
	err := c.cc.Invoke(ctx, "/util.Ping/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

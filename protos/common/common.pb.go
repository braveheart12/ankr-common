...
func (m *ChartVersionDetail) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func (m *ChartVersionDetail) GetAppVersion() string {
	if m != nil {
		return m.AppVersion
	}
	return ""
...
type Namespace struct {
	...
	NsCpuLimit           uint64   `protobuf:"varint,7,opt,name=ns_cpu_limit,json=nsCpuLimit,proto3" json:"ns_cpu_limit,omitempty"`
	NsMemLimit           uint64   `protobuf:"varint,8,opt,name=ns_mem_limit,json=nsMemLimit,proto3" json:"ns_mem_limit,omitempty"`
	NsStorageLimit       uint64   `protobuf:"varint,9,opt,name=ns_storage_limit,json=nsStorageLimit,proto3" json:"ns_storage_limit,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_555bd8c177793206 = []byte{
	...
	,
}
